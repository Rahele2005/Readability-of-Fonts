...
For both Subject 2 and Subject 6, the distribution of fixation durations shows that most fixations are under 1 second.

The highest count of fixations for both subjects occurs in the range of 0 to 0.5 seconds.

In terms of longer fixations, Subject 2 has fixations that can last up to 6 seconds, while Subject 6 has fixations that can last up to 5 seconds

![Fixation Duration for Subject 6 and Subject 2](plots/fixation-duration.png){ width=50% }
...
![Subject 12 Landing Spot on uppercase and lowercase sentences](plots/Subject12-landingspot.png)
